    ...
    <center class="wrapper">
        <table class="main" width="100%">
            <tbody>
                ...
                <tr>
                  <td align="left" style="font-size:0px;padding:8px 25px;word-break:break-word">
                  <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:20px;font-weight:bold;line-height:24px;text-align:left;color:#637381">
                    Company Will Renew Notice
                  </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381">
                    The following service(s) for Company Name is set to renew on {{ $service->end_date }} at a total annual cost of {{ $package->renewal_price }}.
                  </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="left" style="font-size:0px;padding:8px 25px;word-break:break-word">
                  <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381">
                    No action is required and the service(s) shown above will automatically be renewed on the expiry date, using the debit/credit card details we currently hold for you.
                  </div>
                  </td>
                </tr>
                <tr>
                  <td align="left" style="font-size:0px;padding:8px 25px;word-break:break-word">
                  <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381">
                    To check the card details we currently hold for you, or to add a new card, please click the button below:
                  </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="left" style="font-size:0px;padding:8px 25px;word-break:break-word">
                  <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381">
                    Should you wish to discuss the renewal of your service(s), please call your Services Manager 442032900048.
                  </div>
                  </td>
                </tr>
                <tr>
